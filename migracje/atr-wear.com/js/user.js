...
$(document).ready(function () {
    $('header .logo-bar .bbs-wrap.right').append($('#box_languages') );
    $('.footer.row').append("<div class='container--second'><div class='container'></div></div>");
    $('.container--second .container').append($('#fx-social_footer'));
});