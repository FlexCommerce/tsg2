...
/***************************************
    WKLEJENIE SOCIAL DO FOOTERA

$(document).ready(function () {
const socialMedia = document.querySelector('#footer-social-media');
const innerFooter = document.querySelector('.footer .innerfooter');

innerFooter.insertAdjacentElement('beforeend', socialMedia);
})****************************************/